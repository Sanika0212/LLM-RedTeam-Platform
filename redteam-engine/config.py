"""Configuration and keyword lists for heuristic-based detectors."""

# Rename to rt_config internally to avoid conflict with backend config.py
# All detectors import from this file using explicit path resolution
